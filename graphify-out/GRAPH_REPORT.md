...
## Corpus Check
- 271 files · ~236,048 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 705 nodes · 862 edges · 35 communities detected
...
- `saveProvider()` --calls--> `rotateAiProvider()`  [INFERRED]
  artifacts/specflow-ai/src/pages/SettingsPage.tsx → lib/api-client-react/src/generated/api.ts

## Communities

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (123): createExportPackage(), createProject(), exportToGitHub(), exportToJira(), generateClarification(), generateEpics(), generatePrd(), generateQuality() (+115 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (47): getGenerationRuntime(), buildInputSnapshotHash(), GenerationRouteError, getGenerationErrorStatus(), getOutputContract(), hasZodIssues(), markGenerationState(), normalizeProviderJsonContent() (+39 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (31): deleteAiProvider(), getDeleteAiProviderUrl(), getValidateAiProviderUrl(), validateAiProvider(), addToRemoveQueue(), dispatch(), genId(), reducer() (+23 more)

### Community 3 - "Community 3"
Cohesion: 0.12
Nodes (24): ApiError, applyBaseUrl(), buildErrorMessage(), customFetch(), getMediaType(), getStringField(), hasNoBody(), inferResponseType() (+16 more)
...
Cohesion: 0.26
Nodes (14): AiProviderError, buildProviderUrl(), classifyStatus(), createTimeoutSignal(), extractProviderErrorMessage(), normalizeBaseUrl(), parseProviderError(), postChatCompletion() (+6 more)
...
Cohesion: 0.6
Nodes (3): emptyState(), getStepSkillSnapshotForPhase(), parseStoredState()
...
- **Why does `runGeneration()` connect `Community 1` to `Community 8`, `Community 9`, `Community 0`, `Community 7`?**
  _High betweenness centrality (0.152) - this node is a cross-community bridge._
- **Why does `customFetch()` connect `Community 3` to `Community 0`, `Community 2`, `Community 11`, `Community 5`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `generateEpics()` connect `Community 0` to `Community 1`, `Community 3`?**
