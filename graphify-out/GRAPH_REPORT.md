...
## Corpus Check
- 248 files · ~136,804 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 583 nodes · 655 edges · 30 communities detected
...
Cohesion: 0.1
Nodes (20): getWorkspaceAuthContext(), requireAuthContext(), requireMutableWorkspaceContext(), hasZodIssues(), sendError(), sendUnexpectedError(), createApp(), loadApiServerConfig() (+12 more)
...
- **Why does `runGeneration()` connect `Community 2` to `Community 0`, `Community 1`, `Community 5`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `customFetch()` connect `Community 0` to `Community 4`?**
